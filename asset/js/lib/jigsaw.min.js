 ...
 */ !(function(e) {
    ...
    function(e, n, t) {
        ...
        function v() {
            return '//picsum.photos/300/150/?image=' + f(0, 1084);
        }
        function b(e, n, t, r) {
            e.beginPath(),
                e.moveTo(n, t),
                e.arc(n + o / 2, t - s + 2, s, 0.72 * l, 2.26 * l),
                e.lineTo(n + o, t),
                e.arc(n + o + s - 2, t + o / 2, s, 1.21 * l, 2.78 * l),
                e.lineTo(n + o, t + o),
                e.lineTo(n, t + o),
                e.arc(n + s - 2, t + o / 2, s + 0.4, 2.76 * l, 1.24 * l, !0),
                e.lineTo(n, t),
                (e.lineWidth = 2),
                ...
                e.stroke(),
                e[r](),
                (e.globalCompositeOperation = d ? 'xor' : 'overlay');
        }
        function g(e, n) {
            return e + n;
        }
            ...
            return (
                i(e, [
                        ...
                        value: function() {
                            var e = this,
                                n = (function(e) {
                                    ...
                                    e.draw(),
                                        e.canvasCtx.drawImage(n, 0, 0, a, c),
                                        e.blockCtx.drawImage(n, 0, 0, a, c);
                                    var t = e.y - 2 * s - 1,
                                        r = e.blockCtx.getImageData(
                                            e.x - 3,
                                            t,
                                            u,
                                            u,
                    ...
                    },
                    {
                        key: 'draw',
                        value: function() {
                            (this.x = f(u + 10, a - (u + 10))),
                                (this.y = f(10 + 2 * s, c - (u + 10))),
                    ...
                    },
                    {
                        key: 'clean',
                        value: function() {
                            this.canvasCtx.clearRect(0, 0, a, c),
                                this.blockCtx.clearRect(0, 0, a, c),
                                (this.block.width = a);
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            var n = void 0,
                                ...
                                i = !1,
                                o = function(e) {
                                    (n = e.clientX || e.touches[0].clientX),
                                ...
                                s = function(o) {
                                    ...
                                    e.slider.style.left = l + 'px';
                                    var d = ((a - 40 - 20) / (a - 40)) * l;
                                    (e.block.style.left = d + 'px'),
                                        h(
                                            e.sliderContainer,
                                            'sliderContainer_active',
                                        ),
                                        (e.sliderMask.style.width = l + 'px'),
                                        r.push(u);
                                },
                                c = function(t) {
                                    if (!i) return !1;
                                    ...
                                    c
                                        ? l
                                            ...
                                            : (h(
                                              ...
                                              (e.text.innerHTML = '再試一次'),
                                              e.reset())
                                        : (h(
                                              e.sliderContainer,
                                              'sliderContainer_fail',
                                          ),
                                          'function' == typeof e.onFail &&
                                              e.onFail(),
                                          setTimeout(function() {
                                              e.reset();
                                          }, 1e3));
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var e = this.trail,
                                n = e.reduce(g) / e.length,
                                t = e.map(function(e) {
                                    return e - n;
                                }),
                                r = Math.sqrt(t.map(m).reduce(g) / e.length),
    ...
    function(e, n, t) {
            ...
            for (var t = 0; t < e.length; t++) {
                ...
                if (i) {
                    ...
                    for (; s < r.parts.length; s++)
                        i.parts.push(m(r.parts[s], n));
                } else {
                    var a = [];
                    for (s = 0; s < r.parts.length; s++)
                        a.push(m(r.parts[s], n));
        ...
        function b(e) {
            ...
            return (e.attrs.type = 'text/css'), g(n, e.attrs), h(e, n), n;
        }
        function g(e, n) {
                ...
                'function' == typeof btoa
                    ? ((t = (function(e) {
                      ...
                      (r = function(e, n, t) {
                          ...
                          (n.convertToAbsoluteUrls || o) && (r = d(r));
                          i &&
                              (r +=
        ...
        function C(e, n, t, r) {
            ...
            if (e.styleSheet) e.styleSheet.cssText = y(n, i);
                ...
                s[n] && e.removeChild(s[n]),
                    s.length ? e.insertBefore(o, s[n]) : e.appendChild(o);
            }
        }
    },
    function(e, n) {
